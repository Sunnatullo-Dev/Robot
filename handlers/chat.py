...
async def chat_start(call: CallbackQuery, bot: Bot) -> None:
    ...
    await call.message.answer(  # type: ignore[union-attr]
        ...
        "Tugatish uchun <b>🔚 Suhbatni tugatish</b> tugmasini bosing.",
...
async def report_submit(call: CallbackQuery, state: FSMContext, bot: Bot) -> None:
    ...
    await call.message.answer(  # type: ignore[union-attr]
        "✅ Shikoyatingiz ro'yxatga olindi. Adminlar tekshirib chiqadi.",
        reply_markup=reply.main_menu(),
    )
...
# IMPORTANT: Bu handler oxirida ro'yxatdan o'tkazilishi kerak — pastki prioritet
